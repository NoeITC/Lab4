...
# Referenciamos las diferentes vistas por sus respectivas urls
urlpatterns = [
    ...
    path('categorias', views.CategoriaListView.as_view(), name='category-list'),
    path('categorias/<int:pk>', views.CategoriaDetailView.as_view(), name='category-detail'),
]
